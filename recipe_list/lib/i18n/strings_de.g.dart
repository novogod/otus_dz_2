...
class TranslationsDe with BaseTranslations<AppLocale, Translations> implements Translations {
	...
	@override String get pwaInstallTitle => 'Snack Hack auf iPhone oder iPad installieren';
	...
	@override String get addRecipeYoutube => 'YouTube-Link';
...
extension on TranslationsDe {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'pwaInstallTitle' => 'Snack Hack auf iPhone oder iPad installieren',
