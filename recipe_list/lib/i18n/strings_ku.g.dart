...
class TranslationsKu with BaseTranslations<AppLocale, Translations> implements Translations {
	...
	@override String get loginUsername => 'ناوی بەکارهێنەر';
	@override String get loginPassword => 'وشەی نهێنی';
	@override String get loginButton => 'چوونەژوورەوە';
	@override String get logoutButton => 'چوونەدەرەوە';
	@override String get signUp => 'تۆمارکردن';
	@override String get signUpName => 'ناو';
	@override String get signUpEmail => 'ئیمەیڵ';
	@override String get signUpPassword => 'وشەی نهێنی';
	@override String get signUpButton => 'هەژمار دروست بکە';
	@override String get signUpInvalidEmail => 'تکایە ئیمەیڵێکی دروست بنووسە';
	@override String get signUpPasswordTooShort => 'وشەی نهێنی دەبێت لانیکەم 4 پیت بێت';
	@override String get signUpDuplicateUser => 'ئەم بەکارهێنەرە پێشتر هەیە';
	...
	@override String get passwordRecoveryCodeLabel => 'کۆدی گەڕاندنەوە';
	@override String get passwordRecoveryCodeHint => '1234';
	@override String get passwordRecoveryNewPassword => 'وشەی نهێنی نوێ';
	@override String get passwordRecoverySubmit => 'ناردن';
	@override String get passwordRecoveryEnterEmail => 'سەرەتا ئیمەیڵەکەت بنووسە';
	@override String get passwordRecoveryInvalidEmail => 'تکایە ئیمەیڵێکی دروست بنووسە';
	@override String get passwordRecoveryRequestFailed => 'دەستپێکردنی گەڕاندنەوەی وشەی نهێنی سەرکەوتوو نەبوو. دووبارە هەوڵبدەوە.';
	@override String get passwordRecoveryInvalidCode => 'تکایە کۆدێکی دروستی ٤ ژمارەیی داخڵ بکە';
	@override String get passwordRecoveryPasswordTooShort => 'وشەی نهێنی دەبێت لانیکەم ٦ پیت بێت';
	@override String get passwordRecoverySessionExpired => 'دانیشتنی گەڕاندنەوە بەسەرچوو. دووبارە دەستپێبکە.';
	@override String get passwordRecoverySaveFailed => 'پاشەکەوتکردنی وشەی نهێنی نوێ سەرکەوتوو نەبوو. دووبارە هەوڵبدەوە.';
	@override String get passwordRecoverySaved => 'وشەی نهێنی نوێت پاشەکەوت کرا';
	@override String get adminDeleteTitle => 'ڕێسەکە بسڕدرێتەوە؟';
	@override String get adminDeleteMessage => 'ئەمە ڕێسەکە بۆ هەمووان دەسڕێتەوە.';
	@override String get adminDeleteAction => 'سڕینەوە';
	@override String get adminEditAction => 'دەستکاری';
...
extension on TranslationsKu {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'loginUsername' => 'ناوی بەکارهێنەر',
			'loginPassword' => 'وشەی نهێنی',
			'loginButton' => 'چوونەژوورەوە',
			'logoutButton' => 'چوونەدەرەوە',
			'signUp' => 'تۆمارکردن',
			'signUpName' => 'ناو',
			'signUpEmail' => 'ئیمەیڵ',
			'signUpPassword' => 'وشەی نهێنی',
			'signUpButton' => 'هەژمار دروست بکە',
			'signUpInvalidEmail' => 'تکایە ئیمەیڵێکی دروست بنووسە',
			'signUpPasswordTooShort' => 'وشەی نهێنی دەبێت لانیکەم 4 پیت بێت',
			'signUpDuplicateUser' => 'ئەم بەکارهێنەرە پێشتر هەیە',
			...
			'passwordRecoveryCodeLabel' => 'کۆدی گەڕاندنەوە',
			'passwordRecoveryCodeHint' => '1234',
			'passwordRecoveryNewPassword' => 'وشەی نهێنی نوێ',
			'passwordRecoverySubmit' => 'ناردن',
			'passwordRecoveryEnterEmail' => 'سەرەتا ئیمەیڵەکەت بنووسە',
			'passwordRecoveryInvalidEmail' => 'تکایە ئیمەیڵێکی دروست بنووسە',
			'passwordRecoveryRequestFailed' => 'دەستپێکردنی گەڕاندنەوەی وشەی نهێنی سەرکەوتوو نەبوو. دووبارە هەوڵبدەوە.',
			'passwordRecoveryInvalidCode' => 'تکایە کۆدێکی دروستی ٤ ژمارەیی داخڵ بکە',
			'passwordRecoveryPasswordTooShort' => 'وشەی نهێنی دەبێت لانیکەم ٦ پیت بێت',
			'passwordRecoverySessionExpired' => 'دانیشتنی گەڕاندنەوە بەسەرچوو. دووبارە دەستپێبکە.',
			'passwordRecoverySaveFailed' => 'پاشەکەوتکردنی وشەی نهێنی نوێ سەرکەوتوو نەبوو. دووبارە هەوڵبدەوە.',
			'passwordRecoverySaved' => 'وشەی نهێنی نوێت پاشەکەوت کرا',
			'adminDeleteTitle' => 'ڕێسەکە بسڕدرێتەوە؟',
			'adminDeleteMessage' => 'ئەمە ڕێسەکە بۆ هەمووان دەسڕێتەوە.',
			'adminDeleteAction' => 'سڕینەوە',
			'adminEditAction' => 'دەستکاری',
