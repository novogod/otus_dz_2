...
/// Максимальная ширина «карточек» экранов аутентификации
/// (Login / Signup / Password recovery). Соответствует
/// вертикальной ширине типичного iPhone Pro: на узких
/// устройствах форма растягивается до краёв минус
/// `AppSpacing.xl`, а на iPad / десктопе центрируется и
/// не уезжает к краям экрана.
